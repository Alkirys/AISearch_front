...
class UsersList {
    constructor() {
        this.mainContainerElement = document.getElementById('mainContainer');
    }
    ...
    render() {
        if (Array(this.usersList).length === 0) {
        ...
        this.mainContainerElement.innerHTML += `
            <header id="header" class="header">
                <div class="header__buttonGroup">
                    <p id="mainButton" class="header__button header__button--active">AISearch</p>
                    <p id="aboutButton" class="header__button header__button--passive">about us</p>
                </div>
                <div class="header__buttonGroup">
                    <a class="header__iconGroup" href="https://t.me/InternalServerAI" target="_blank">
                        <p id="contactButton" class="header__button header__button--passive">contact us</p>
...
class PhotoContainer {
    ...
    render() {
        ...
        this.mainContainerElement.innerHTML += `
            <div id="photoContainer" class="photoContainer" style="height: ${photoMaxWidth}px">
    ...
    render() {
        this.place.innerHTML = `
            ...
            <label for="inputFile" class="input__label">
                ...
                <span class="input__button">Выбрать</span>
            </label>
